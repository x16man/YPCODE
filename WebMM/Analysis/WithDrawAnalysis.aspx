<%@ Page Language="c#" CodeBehind="WithDrawAnalysis.aspx.cs" AutoEventWireup="True"
    Inherits="WebMM.Analysis.WithDrawAnalysis" %>
    ...
    <font face="宋体">
        <table id="Table1" cellspacing="1" cellpadding="1" width="100%">
            <tr>
                <td valign="top" style="height: 53px">
                    <igmisc:webpanel id="WebPanel1" runat="server" Width="100%" BackColor="#E0DED2">
                        <header text="&amp;nbsp;&amp;nbsp;发料统计" textalignment="Left">
									<ExpandedAppearance>
									...
									<TABLE borderColor="black" width="100%" border="1">
										<TR>
											<TD>
												<TABLE width="100%">
													<TR>
														<TD colSpan="2">发料数据的呈现可以有6中组合：</TD>
													</TR>
													<TR>
											...
											<TD vAlign="top" >
												<TABLE width="100%">
													...
													<TR>
														<TD style="HEIGHT: 40px;width:40%" >开始日期：
														</TD>
													...
													<TR>
														<TD style="HEIGHT: 39px">结束日期：
														</TD>
														<TD style="HEIGHT: 39px;width:45px">
                        ...
                        <tr>
                            ...
                            <td width="300" valign="top" align="right">
                                <dcwc:Chart ID="Chart1" runat="server" BackColor="LightSteelBlue" Palette="Pastel"
                                    BorderLineColor="LightSlateGray" Height="550px">
                                    <Legends>
                                        <dcwc:Legend BorderColor="Gray" Name="Default" BackColor="Lavender" ShadowOffset="2">
                                        </dcwc:Legend>
                                    </Legends>
                                    <Series>
                                    ...
                                    <Titles>
                                        <dcwc:Title Font="楷体_GB2312, 14.25pt, style=Bold" Text="发料统计分析">
                                        </dcwc:Title>
                                    </Titles>
            ...
            <tr>
                <td align="center">
                    <div class="hidden">
                    <asp:TextBox ID="txtGroupString" runat="server" Width="0px"></asp:TextBox><asp:TextBox
                        ID="txtOrderString" runat="server" Width="0px"></asp:TextBox><asp:Button ID="btnQuery"
                            runat="server" Width="0px" Text="查询" onclick="btnQuery_Click"></asp:Button><asp:Button ID="btnHREF" runat="server"
                                Width="0px" Text="HREF" onclick="btnHREF_Click"></asp:Button></div>
                </td>
            </tr>
        </table>
    </font>
