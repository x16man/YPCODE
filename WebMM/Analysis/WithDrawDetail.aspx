<%@ Page Language="c#" CodeBehind="WithDrawDetail.aspx.cs" AutoEventWireup="True"
    Inherits="MZHMM.WebMM.WithDrawDetail" %>
                    ...
                    <tr>
                            ...
                            <table width="100%" height="100%">
                                <tr>
                                    <td background="../Images/Header.jpg" style="height: 56px">
                                        <font face="宋体" color="#1b59a0" size="5"><strong>&nbsp;发料详细情况</strong></font>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <td>
                            <igmisc:webpanel id="WebPanel1" runat="server" Width="100%">
                                ...
                                <header text="发料属性" textalignment="Right">
											<ExpandedAppearance>
                                ...
                                <template>
											<TABLE class="OnePixelTable" height="100%" cellSpacing="0" cellPadding="0" width="100%"
												border="0">
												<TR>
													<TD width="100">&nbsp;&nbsp;用途分类：</TD>
													<TD>
														<asp:label id="lblClassify" runat="server">&nbsp;</asp:label></TD>
												</TR>
												<TR>
													<TD>&nbsp;&nbsp;用&nbsp;&nbsp;&nbsp;&nbsp;途：</TD>
													<TD>
														<asp:label id="lblReqReason" runat="server">&nbsp;</asp:label></TD>
												</TR>
												<TR>
													<TD>&nbsp;&nbsp;部&nbsp;&nbsp;&nbsp;&nbsp;门：</TD>
													<TD>
														<asp:label id="lblAuthorDeptName" runat="server">&nbsp;</asp:label></TD>
												</TR>
												<TR>
													<TD>&nbsp;&nbsp;总&nbsp;&nbsp;金额：</TD>
													<TD>
