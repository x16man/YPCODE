...
namespace WebMM 
{
	...
	public class BasePage : System.Web.UI.Page
    {
        ...
        protected override void InitializeCulture()
        {
            ...
            if (this.CurrentUser.UICulture != "zh-CN")
            {
                Thread.CurrentThread.CurrentCulture = CultureInfo.CreateSpecificCulture(this.CurrentUser.UICulture);
                Thread.CurrentThread.CurrentUICulture = new CultureInfo(this.CurrentUser.UICulture);
            }
        }
		#endregion
	}
