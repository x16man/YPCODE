<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.Master" AutoEventWireup="true" CodeBehind="InventoryShortageInput.aspx.cs" Inherits="WebMM.Storage.InventoryShortageInput" %>
<%@ MasterType VirtualPath="~/Master/Default.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<title>盘亏单</title>
<link rel="stylesheet" type="text/css" href="../CSS/Storage/InventoryShortageInput.css" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyHolder" runat="server">
    <table class="myTable myTableToolbar" id="Table1" cellspacing="1" >
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:DropDownList runat="server" ID="ddlStorage" Width="100%" ></asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <td width="80px"><asp:TextBox ID="txtCarryingAmount" ToolTip="账面数量"  runat="server"></asp:TextBox></td>
        <td width="80px"><asp:TextBox ID="txtInventoryAmount" ToolTip="盘点数量"  runat="server"></asp:TextBox></td>
        <td width="80px">
            <asp:TextBox ID="txtItemNum" ToolTip="数量"  runat="server"></asp:TextBox>
        </td>
        ...
        <td valign="top" colspan="9" height="160">
            <mzh:MzhDataGrid ID="DGModel_Items1" runat="server" IdCell="0" MultiPageShowMode="DropListMode"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="CurrentStockNum" SortExpression="CurrentStockNum" HeaderText="当前库存">
                    ...
                    <asp:BoundColumn DataField="ItemNum" SortExpression="ItemNum" HeaderText="盘亏数量" >
                        <ItemStyle HorizontalAlign="Right" />
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox runat="server" ID="txtStoManager"></asp:TextBox>
            </td>
            <td>
                发料日期：
            </td>
            <td align="left">
                <asp:TextBox ID="txtDrawDate" runat="server"></asp:TextBox>
            </td>
        </tr>
