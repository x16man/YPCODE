<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryProfitList.aspx.cs" Inherits="WebMM.Storage.InventoryProfitList" %>
...
<body>
    ...
    <div>
        ...
        <mzh:toolbarbutton cellpadding="0" labelclass="labelCell" tableclass="buttonTable"
            ...
            iconclass="in" hasicon="True" text="收料" id="toolbarButtonReceive" onclick="receiveItem(this.id)">
        </mzh:toolbarbutton>
        <mzh:toolbarbutton cellpadding="0" labelclass="labelCell" tableclass="buttonTable"
    ...
    <script type="text/javascript">
        ...
        function newItem(elmId) {
            popupWindow.setUrl("InventoryProfitInput.aspx?OP=New");
        ...
        function editItem(elmId) {
            if (DataGrid1_obj.getSelectedArray() != null && DataGrid1_obj.getSelectedArray() != "") {
                popupWindow.setUrl("InventoryProfitInput.aspx?OP=Edit&EntryNo=" + DataGrid1_obj.getSelectedID());
                popupWindow.showPopup(elmId, false);
                return false;
            }
            else {
        ...
        function firstAuditItem(elmId) {
            if (DataGrid1_obj.getSelectedArray() != null && DataGrid1_obj.getSelectedArray() != "") {
                popupWindow.setUrl("InventoryProfitInput.aspx?OP=FirstAudit&EntryNo=" + DataGrid1_obj.getSelectedID());
                popupWindow.showPopup(elmId, false);
                return false;
            }
            else {
        ...
        function secondAuditItem(elmId) {
            if (DataGrid1_obj.getSelectedArray() != null && DataGrid1_obj.getSelectedArray() != "") {
                popupWindow.setUrl("InventoryProfitInput.aspx?OP=SecondAudit&EntryNo=" + DataGrid1_obj.getSelectedID());
                popupWindow.showPopup(elmId, false);
                return false;
            }
            else {
        ...
        function thirdAuditItem(elmId) {
            if (DataGrid1_obj.getSelectedArray() != null && DataGrid1_obj.getSelectedArray() != "") {
                popupWindow.setUrl("InventoryProfitInput.aspx?OP=ThirdAudit&EntryNo=" + DataGrid1_obj.getSelectedID());
                popupWindow.showPopup(elmId, false);
                return false;
            }
            else {
        ...
        function receiveItem(elmId) {
            if (DataGrid1_obj.getSelectedArray() != null && DataGrid1_obj.getSelectedArray() != "") {
                popupWindow.setUrl("InventoryProfitInput.aspx?OP=In&EntryNo=" + DataGrid1_obj.getSelectedID());
                popupWindow.showPopup(elmId, false);
                return false;
            }
            else {
        ...
        function redItem(elmId) {
            if (DataGrid1_obj.getSelectedArray() != null && DataGrid1_obj.getSelectedArray() != "") {
                popupWindow.setUrl("InventoryProfitInput.aspx?OP=Red&EntryNo=" + DataGrid1_obj.getSelectedID());
                popupWindow.showPopup(elmId, false);
                return false;
            }
            else {
