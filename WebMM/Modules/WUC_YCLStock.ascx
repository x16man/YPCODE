<%@ Control Language="c#" AutoEventWireup="True" Codebehind="WUC_YCLStock.ascx.cs" Inherits="WebMM.Modules.WUC_YCLStock" %>
...
<meta name="vs_showGrid" content="False">
	<igtbl:UltraWebGrid id="UG_YCL" runat="server" ondatabinding="UG_YCL_DataBinding">
			<DisplayLayout AllowDeleteDefault="Yes" AllowSortingDefault="OnClient" RowHeightDefault="20px"
				...
				RowSelectorsDefault="No" Name="xctl0xUltraWebGrid2" AllowUpdateDefault="Yes">
