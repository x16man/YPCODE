...
function PopupWindow_showPopup(anchorname) {
    ...
    if (this.divName != null) {
        ...
        if (this.popupWindow == null || this.popupWindow.closed) {
            ...
            this.popupWindow = window.open("about:blank", "window_" + anchorname.replace(/=/g, "").replace(/#/g, ""), this.windowProperties + ",width=" + this.width + ",height=" + this.height + ",screenX=" + this.x + ",left=" + this.x + ",screenY=" + this.y + ",top=" + this.y + "");
        }
        this.refresh();
    }
}
...
function PopupWindow() {
    ...
    this.contents = "";
    this.url = "";
    this.windowProperties = "toolbar=no,location=no,status=true,menubar=no,scrollbars=no,resizable,alwaysRaised,dependent,titlebar=no";
