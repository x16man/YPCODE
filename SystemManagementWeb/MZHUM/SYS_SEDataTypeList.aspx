<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SYS_SEDataTypeList.aspx.cs"
    Inherits="SystemManagement.MZHUM.SYS_SEDataTypeList" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>查询引擎数据类型</title>
    ...
    <script src="../JS/MZHUM/SYS_SEDataTypeList.js" type="text/javascript"></script>
...
<body>
    ...
    <div id="main">
        ...
        <mzh:MzhDataGrid ID="dg_SEDataTypeInfo" runat="server" name="MzhMultiSelectDataGrid"
