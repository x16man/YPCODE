<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SYS_GroupEdit.aspx.cs" Inherits="SystemManagement.MZHUM.SYS_GroupEdit" %>
...
<body>
    ...
    <div id="main">
        ...
        <div class="fieldWrapper">
            <fieldset>
                <legend>组信息</legend>
                <label for="ddlGroupCat">分类：</label>
                <div><asp:DropDownList ID="ddlGroupCat" runat="server"></asp:DropDownList></div>
                <label for="txtName">
                ...
                <label for="txtSerialNo">序号：</label><asp:RangeValidator ID="rvSerialNo" runat="server" ControlToValidate="txtSerialNo" Display="Dynamic" Type="Integer" MinimumValue="0" MaximumValue="999">0~999</asp:RangeValidator>
                <div><asp:TextBox ID="txtSerialNo" runat="server" TextMode="SingleLine"></asp:TextBox></div>
            </fieldset>
        </div>
    </div>
    </form>
