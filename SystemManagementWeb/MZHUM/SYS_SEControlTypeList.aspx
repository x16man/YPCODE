<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SYS_SEControlTypeList.aspx.cs" Inherits="SystemManagement.MZHUM.SYS_SEControlTypeList" %>
...
<head runat="server">
    ...
    <script src="../JS/MZHUM/SYS_SEControlTypeList.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div id="main">
        ...
        <mzh:MzhDataGrid ID="dg_SEControlTypeInfo" runat="server" name="MzhMultiSelectDataGrid"
            ...
            <Columns>
                <asp:BoundColumn DataField="Id" SortExpression="Id" HeaderText="Id" Visible="True">
