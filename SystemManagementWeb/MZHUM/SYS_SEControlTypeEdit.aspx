<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SYS_SEControlTypeEdit.aspx.cs" Inherits="SystemManagement.MZHUM.SYS_SEControlTypeEdit" %>
...
<body>
    ...
    <div id="main">
        ...
        <div class="fieldWrapper">
            <fieldset>
                <legend>控件类型信息</legend>
                <label for="txtId">
                    控件类型ID：<span class="required">*</span></label>
                <asp:RequiredFieldValidator ID="rfvId" runat="server" ControlToValidate="txtId"
                    Display="Dynamic" ErrorMessage="">必须输入控件类型Id</asp:RequiredFieldValidator>
                ...
                <label for="txtName">控件类型名称：<span class="required">*</span></label>
                <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName"
                    Display="Dynamic" ErrorMessage="">必须输入控件类型名称</asp:RequiredFieldValidator>
                <div>
