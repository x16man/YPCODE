...
{
    public abstract class TagProvider:ITag
    {
        ...
        public abstract TagInfo GetByTagId(string tagId);

        /// <summary>
        /// 获取所有的指标信息实体集合。
        /// </summary>
        /// <returns>指标信息实体集合</returns>
        public abstract IList<TagInfo> GetAll();
        ...
        public abstract IList<TagInfo> GetByAction(short action);
