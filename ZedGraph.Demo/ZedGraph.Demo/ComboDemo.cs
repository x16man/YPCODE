...
namespace ZedGraph.Demo
{
	...
	public class ComboDemo : DemoBase
	{
									...
									"Combo Demo", DemoType.General, DemoType.Line )
		{
		    ...
		    //myPane.XAxis.Color = Color.FromArgb(179, 0, 0);
		    //myPane.YAxis.Color = Color.FromArgb(179, 0, 0);
		    //myPane.X2Axis.Color = Color.FromArgb(179, 0, 0);
		    //myPane.XAxis.MajorGrid.Color = Color.FromArgb(179, 0, 0);
		    //myPane.YAxis.MajorGrid.Color = Color.FromArgb(179, 0, 0);
            
            base.ZedGraphControl.InitFromConfig();
