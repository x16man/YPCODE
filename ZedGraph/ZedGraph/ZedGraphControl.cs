	...
	#region Methods
		...
		protected override void OnPaint( PaintEventArgs e )
		{
			lock ( this )
			{
                ...
                //鼠标移过时选中节点。Added By Wang Junhui.
...
*/
        ...
        /// <summary>
        /// 获取或设置定位器的(光标)位置。相对于ZedGraphControl的坐标。
        /// </summary>
        ...
        private void DrawGuideLines(Graphics g)
        {
            ...
            if (_curveItem != null && _curveItem.CurrentPtIndex > -1 && _curveItem.CurrentPtIndex < _curveItem.NPts)
            {
                ...
                {
                    //g.DrawLine(GuideLinePen, new Point(rectangle.Left, this.GuidePoint.Y), new Point(rectangle.Right, this.GuidePoint.Y));//鼠标位置横线。
                    //g.DrawLine(GuideLinePen, new PointF(rectangle.Left, realY), new PointF(rectangle.Right, realY));//实际曲线点位置横线。
        ...
        /// <summary>
        /// 向左或向右移动 indexSkip 步定位器。出界返回false;否则返回true.
        /// </summary>
        /// <param name="indexSkip">步长。</param>
        /// <returns>出界返回false;否则返回true.</returns>
        ...
        /// <summary>
        /// 向左或向右移动一步定位器。出界返回false;否则返回true.
        /// </summary>
