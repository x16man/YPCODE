...
namespace ZedGraph
{
	...
	#region Rendering Methods
			...
			float scaleFactor, SizeF layoutArea )
		{
            ...
            strFormat.FormatFlags |= StringFormatFlags.NoClip;//Added by Wang Junhui.
        ...
        /// <summary>
        /// Added By Wang Junhui£¬ÎªÁË·µ»ØlayoutArea¡£
        /// </summary>       
        public void Draw(Graphics g, PaneBase pane, string text, float x,
            float y, AlignH alignH, AlignV alignV,
            float scaleFactor, out SizeF layoutArea)
        {
            // make sure the font size is properly scaled
            //Remake( scaleFactor, this.Size, ref this.scaledSize, ref this.font );
            ...
            //Modified By Wang Junhui.            
            SizeF sizeF = MeasureString(g, text, scaleFactor);            
            layoutArea = sizeF;            
