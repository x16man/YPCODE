...
namespace ZedGraph
{
	...
	#region Constructors
        ...
        public BarItem(string label, double[] x, double[] y, Color color, Color negativeColor)
            : this(label, new PointPairList(x, y), color, negativeColor)
        {
        }
		/// <summary>
		/// Create a new <see cref="BarItem"/> using the specified properties.
		...
		public BarItem(string label, IPointList points, Color color,Color negativeColor)
            :base(label,points)
		{
		    _bar = new Bar(color,negativeColor);
		}
		/// <summary>
