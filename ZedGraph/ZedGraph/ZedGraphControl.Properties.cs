...
namespace ZedGraph
{
	...
	#region Properties
		...
		*/
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
            DefaultValue(false),
            Description("true to show horizontal guide line")]
        public bool IsShowHorizontalGuideLine
        {
            get; set;
        }
        /// <summary>
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
            DefaultValue(false),
            Description("true to show vetical guide line")]
        public bool IsShowVerticalGuideLine
        {
            get; set;
        }
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
            DefaultValue(false),
            Description("Guide line's Color")]
        public Color GuideLineColor
        {
            get { return _guideLineColor; }
            set { _guideLineColor = value; }
        }
        //public Point HorizontalGuideLineStart
        //{
        //    get; set;
        //}
        //public Point HorizontalGuideLineEnd
        //{
        //    get; set;
        //}
        //public Point VerticalGuideLineStart
        //{
        //    get; set;
        //}
        //public Point VerticalGuideLineEnd
        //{
        //    get; set;
        //}
        
        public PointPair CurrentPoint { get; private set; }
        /// <summary>
        /// 浮动窗口。
        /// </summary>
        public List<FloatingBlock> FloatingBlocks 
        {
            get { return this._floatingBlocks; }
        }
	#endregion
