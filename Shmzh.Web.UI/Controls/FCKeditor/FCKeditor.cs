...
namespace Shmzh.Web.UI.Controls.FCKeditor
{
    ...
    [Designer("Shmzh.Web.UI.Designer.FCKeditorDesigner")]
	[ ParseChildren(false) ]
	public class FCKeditor : System.Web.UI.Control, IPostBackDataHandler
	{
		...
		public string BasePath
		{
			get 
			{ 
				var o = ViewState["BasePath"] ; 

				if ( o == null )
					o = ConfigurationManager.AppSettings["FCKeditor:BasePath"] ;
		...
		{
			get { var o = ViewState["ToolbarSet"] ; return ( o == null ? "Default" : (string)o ) ; }
