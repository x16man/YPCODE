...
namespace Shmzh.MM.Common
{
	...
	public class CurrentABCStockData :DataSet
	{
		#region 成员变量
		public const string ABC_Table = "CurrentABC";
		...
		{
			DataTable table   = new DataTable(ABC_Table);
			//添加字段。
		...
		/// </summary>
		private CurrentABCStockData(SerializationInfo info, StreamingContext context) : base(info, context) 
		{		
		}
		public CurrentABCStockData()
		{
