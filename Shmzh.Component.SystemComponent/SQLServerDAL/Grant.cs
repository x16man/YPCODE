...
Where PKID = @Id";
        ...
        /// </summary>
        /// <returns></returns>
        private static SqlParameter[] GetGrantParameters()
        {
            var parms = SqlHelperParameterCache.GetCachedParameterSet(ConnectionString.PubData, SQL_INSERT_GRANT);
            if (parms == null)
            {
                parms = new[]
                            {
                                new SqlParameter("@Id", SqlDbType.BigInt){Direction = ParameterDirection.InputOutput},
                                new SqlParameter("@Grantor", SqlDbType.NVarChar,20), 
                                new SqlParameter("@GrantorName", SqlDbType.NVarChar,20),
                                new SqlParameter("@GrantorDept", SqlDbType.NVarChar,20),
                                new SqlParameter("@Embracer", SqlDbType.NVarChar,20),
                                new SqlParameter("@EmbracerName", SqlDbType.NVarChar, 20),
                                new SqlParameter("@EmbracerDept", SqlDbType.NVarChar,20),
                                new SqlParameter("@IsLeaf", SqlDbType.Bit),
                                new SqlParameter("@CreateTime", SqlDbType.SmallDateTime),
                                new SqlParameter("@InvalidTime", SqlDbType.SmallDateTime),
                                new SqlParameter("@IsValid", SqlDbType.Bit),
                                new SqlParameter("@EffectTime",SqlDbType.SmallDateTime),
                                new SqlParameter("@LoginIsValid", SqlDbType.Bit),
                                new SqlParameter("@Reason", SqlDbType.NVarChar, 255), 
                            };

                SqlHelperParameterCache.CacheParameterSet(ConnectionString.PubData, SQL_INSERT_GRANT, parms);
            }
            return parms;
        }
        /// <summary>
        ...
        public bool Insert(GrantInfo grantInfo)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(ConnectionString.PubData, CommandType.Text, SQL_INSERT_GRANT, parms);
        ...
        public bool Update(GrantInfo grantInfo)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(ConnectionString.PubData, CommandType.Text, SQL_UPDATE_GRANT, parms);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Delete(GrantInfo grantInfo)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(ConnectionString.PubData, CommandType.Text, SQL_DELETE_GRANT, parms);
                return true;
            }
            catch (Exception ex)
            {
