...
";
        ...
        private static OleDbParameter[] GetGroupRoleParameters()
        {
            var parms = AccessHelperParameterCache.GetCachedParameterSet(ConnectionString.PubData, SQL_INSERT_GROUPROLE);
            if (parms == null)
            {
                parms = new[]
                            {
                ...
                AccessHelperParameterCache.CacheParameterSet(ConnectionString.PubData, SQL_INSERT_GROUPROLE, parms);
            }
            return parms;
        }
        /// <summary>
        ...
        public bool Insert(GroupRoleInfo groupRoleInfo)
        {
            ...
            try
            {
                AccessHelper.ExecuteNonQuery(ConnectionString.PubData,  SQL_INSERT_GROUPROLE, parms);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Insert(string groupCodes, string roleCodes, short productCode)
        {
            var parms = new[]
                            {
                                new OleDbParameter("@GroupCodeList", OleDbType.VarChar,4000) {Value = groupCodes},
                                new OleDbParameter("@RoleCodeList", OleDbType.VarChar, 4000) {Value = roleCodes},
                                new OleDbParameter("@ProductCode", OleDbType.SmallInt){Value = productCode}, 
                            };
            try
            {
                AccessHelper.ExecuteNonQuery(ConnectionString.PubData,  SQL_INSERT_GROUPSROLES, parms);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Insert(string groupCodes, string roleCodes, string checkCode, string type)
        {
            ...
            try
            {
                AccessHelper.ExecuteNonQuery(ConnectionString.PubData,  SQL_INSERT_GROUPSROLESBYCHECKCODE,
                                          parms);
                return true;
            }
            catch (Exception ex)
        ...
        public bool Delete(GroupRoleInfo groupRoleInfo)
        {
            ...
            try
            {
                AccessHelper.ExecuteNonQuery(ConnectionString.PubData,  SQL_DELETE_GROUPROLE, parms);
                return true;
            }
            catch (Exception ex)
            {
        ...
        {
            var parms = new[] {
                new OleDbParameter("@GroupCode",OleDbType.SmallInt){Value = groupCode},
                new OleDbParameter("@ProductCode", OleDbType.SmallInt){Value = productCode},
            };
            var dr = AccessHelper.ExecuteReader(ConnectionString.PubData,  SQL_SELECT_BY_GROUPCODE_PRODUCTCODE, parms);
        ...
        public IList<GroupRoleInfo> GetByGroupCodeAndCheckCodeAndType(short groupCode, string checkCode, string type)
        {
            ...
            var dr = AccessHelper.ExecuteReader(ConnectionString.PubData,  SQL_SELECT_BY_GROUPCODE_CHECKCODE_TYPE, parms);
            IList<GroupRoleInfo> objs = new ListBase<GroupRoleInfo>();
            while (dr.Read())
            {
                objs.Add(ConvertToGroupRoleInfo(dr));
        ...
        public IList<GroupRoleInfo> GetByProductCodeAndGroupCode(short productCode, short groupCode)
        {
            ...
            var dr = AccessHelper.ExecuteReader(ConnectionString.PubData,  SQL_SELECT_BY_PRODUCTCODE_GROUPCODE, parms);
            IList<GroupRoleInfo> objs = new ListBase<GroupRoleInfo>();
            while (dr.Read())
            {
                objs.Add(ConvertToGroupRoleInfo(dr));
        ...
        public bool CopyTo(string sourceGroupCode, string targetGroupCode, short productCode)
        {
            var parms = new[]
                            {
                                new OleDbParameter("@SourceGroupCode",OleDbType.VarChar,4000){Value = sourceGroupCode},
                                new OleDbParameter("@TargetGroupCode",OleDbType.VarChar,4000){Value = targetGroupCode},
                                new OleDbParameter("@ProductCode", OleDbType.VarChar,50){Value = productCode},
                            };
            try
            {
                AccessHelper.ExecuteNonQuery(ConnectionString.PubData, SQL_COPYTOGROUPROLE_BY_SOURCEGROUPCODE_TARGETGROUPCODE_PRODUCTCODE,
                                          parms);
                return true;
            }
            catch (Exception ex)
