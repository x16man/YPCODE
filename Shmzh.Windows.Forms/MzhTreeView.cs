...
namespace Shmzh.Windows.Forms
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(TreeViewDragDrop), "Sloppycode.UI.DragDropTreeView.bmp"),Description("A treeview with inbuilt drag-drop support and custom cursor/icon dragging.")]
    public class TreeViewDragDrop : System.Windows.Forms.TreeView
    {
        ...
        /// </summary>
        [Description("The imagelist control from which DragImage icons are taken."),Category("Drag and drop")]
