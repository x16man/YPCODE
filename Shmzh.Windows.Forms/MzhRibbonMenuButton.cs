...
{
    public class MzhRibbonMenuButton : Button
    {
        #region About Constructor
        public MzhRibbonMenuButton()
        {
            ...
            else
            {
                ...
                if (_keeppress)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (typeof(MzhRibbonMenuButton) == _control.GetType() & _control.Name != this.Name)
                            {
                                ((MzhRibbonMenuButton)(_control))._ispressed = false;
                                ((MzhRibbonMenuButton)(_control)).UpdateLeave();
                            }
                        }
                    }
                    catch { }
