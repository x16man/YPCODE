...
{
    class SqlDigitalProvider:DigitalProvider
    {
        #region Field
        ...
        #region CTOR
        /// <summary>
		/// Creates a new <see cref="SqlDigitalProvider"/> instance.
		/// </summary>
		public SqlDigitalProvider()
		{
		}
        /// <summary>
	    /// Creates a new <see cref="SqlDigitalProvider"/> instance.
	    ...
	    public SqlDigitalProvider(string connectionString, string providerInvariantName)
	    {
        ...
        /// </summary>
        /// <param name="dr"></param>
        /// <returns>DigitalInfo</returns>
        private static DigitalInfo ConvertToDigitalInfo(IDataRecord dr)
        {
            var obj = new DigitalInfo();
        ...
        #region Overrides of DigitalProvider
        ...
        public override List<DigitalInfo> GetByTime(DateTime time)
        {
...
,       A.[时间]
,       A.[值]
From    LINK_3rd.[int].dbo.Digital{0} As A,T_Tag_Gather B
