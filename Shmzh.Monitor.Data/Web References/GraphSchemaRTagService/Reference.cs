...
namespace Shmzh.Monitor.Data.GraphSchemaRTagService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="GraphSchemaRTagSoap", Namespace="http://tempuri.org/")]
    public partial class GraphSchemaRTag : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetByTabIdOperationCompleted;
        ...
        /// <remarks/>
        public GraphSchemaRTag() {
            this.Url = global::Shmzh.Monitor.Data.Properties.Settings.Default.Shmzh_Monitor_Data_GraphSchemaRTag_GraphSchemaRTag;
        ...
        /// <remarks/>
        public event GetByTabIdCompletedEventHandler GetByTabIdCompleted;
        ...
        public GraphSchemaRTagInfo[] GetAll() {
            object[] results = this.Invoke("GetAll", new object[0]);
            return ((GraphSchemaRTagInfo[])(results[0]));
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetByTabId", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public GraphSchemaRTagInfo[] GetByTabId(int tabId) {
            object[] results = this.Invoke("GetByTabId", new object[] {
                        tabId});
            return ((GraphSchemaRTagInfo[])(results[0]));
        }
        
        /// <remarks/>
        public void GetByTabIdAsync(int tabId) {
            this.GetByTabIdAsync(tabId, null);
        }
        
        /// <remarks/>
        public void GetByTabIdAsync(int tabId, object userState) {
            if ((this.GetByTabIdOperationCompleted == null)) {
                this.GetByTabIdOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetByTabIdOperationCompleted);
            }
            this.InvokeAsync("GetByTabId", new object[] {
                        tabId}, this.GetByTabIdOperationCompleted, userState);
        }
        
        private void OnGetByTabIdOperationCompleted(object arg) {
            if ((this.GetByTabIdCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetByTabIdCompleted(this, new GetByTabIdCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        public void InsertAsync(GraphSchemaRTagInfo rTagInfo) {
            this.InsertAsync(rTagInfo, null);
        }
        
        /// <remarks/>
        public void InsertAsync(GraphSchemaRTagInfo rTagInfo, object userState) {
            ...
            this.InvokeAsync("Insert", new object[] {
                        rTagInfo}, this.InsertOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void UpdateAsync(GraphSchemaRTagInfo rTagInfo) {
            this.UpdateAsync(rTagInfo, null);
        }
        
        /// <remarks/>
        public void UpdateAsync(GraphSchemaRTagInfo rTagInfo, object userState) {
            if ((this.UpdateOperationCompleted == null)) {
                this.UpdateOperationCompleted = new System.Threading.SendOrPostCallback(this.OnUpdateOperationCompleted);
            }
            this.InvokeAsync("Update", new object[] {
                        rTagInfo}, this.UpdateOperationCompleted, userState);
        }
    ...
    public partial class GetAllCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public GraphSchemaRTagInfo[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((GraphSchemaRTagInfo[])(this.results[0]));
            }
        }
    }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void GetByTabIdCompletedEventHandler(object sender, GetByTabIdCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetByTabIdCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetByTabIdCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
